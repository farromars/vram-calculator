...
export const ZH = {
  ...
  customModel: {
    vendorLabel: '自定义',
    addNew: '新建自定义模型',
    savedTitle: '已保存的自定义模型',
    formTitle: '自定义模型配置',
    formSubtitle: '手动输入模型架构参数，支持私有模型和实验性模型',
    nameLabel: '模型名称',
    namePlaceholder: '例如：MyLLM-13B',
    architectureLabel: '架构类型',
    paramsLabel: '参数量 (B)',
    paramsPlaceholder: '例如：13',
    hiddenSizeLabel: '隐藏层维度',
    hiddenSizePlaceholder: '例如：5120',
    numLayersLabel: '层数',
    numLayersPlaceholder: '例如：40',
    numHeadsLabel: '注意力头数',
    numHeadsPlaceholder: '例如：40',
    numKVHeadsLabel: 'KV 头数（GQA/MQA，选填）',
    numKVHeadsPlaceholder: '默认与注意力头数相同',
    vocabSizeLabel: '词表大小',
    vocabSizePlaceholder: '例如：32000',
    activeParamsLabel: 'MoE 激活参数量 (B)',
    activeParamsPlaceholder: '例如：13（仅 MoE 架构）',
    estimatedParams: '估算参数量',
    useConfig: '使用此配置',
    savePreset: '保存为常用',
    cancel: '取消',
    deleteConfirm: '确定删除此自定义模型？',
    badge: '自定义',
    errorName: '请输入模型名称',
    ...
    archTransformer: 'Transformer（标准）',
    archMoE: 'MoE（混合专家）',
    archGLM: 'GLM',
    maxSavedHint: '最多保存 10 个自定义模型',
  },
